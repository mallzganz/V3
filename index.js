...
//Respon
			mess = {
				...
				success: 'Nih deks jan lupa Follow IG : https://instagram.com/m.a.l.l.zganz',
				error: {
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			Ramdani.sendMessage(from, teks, text, { thumbnail: thumb, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `New Base By MALLZ STORE`,body:"© Creator By MALLZ STORE",previewType:"PHOTO",thumbnail:thumb,sourceUrl:``}}})
		}
		const reply2 = (teks) => {
	...
	participant : '0@s.whatsapp.net'},
       message: {
              orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `New Base By MALLZ STORE \nRp. 999.999.999`, 
                            orderTitle: `© Creator By MALLZ STORE`,
                            thumbnail: thumb, 
...
const froxx = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `© Creator MALLZ STORE`,
                 "title": `© Creator MALLZ STORE`,
                 'jpegThumbnail': fs.readFileSync("./media/foto/thumb.jpg"),
                        }
	                  } 
                     }
runi = process.uptime() 
           Ramdani.setStatus(`X-Z BOT Aktif Selama ${(runi)} `).catch((_)=>_);
...
if (isBanned) return reply(mess.banned)
 ...
 footerText: '© Creator By MALLZ STORE',
...
if (isBanned) return reply(mess.banned)
 ...
 rows: [
                       ...
                       "rowId": `${prefix}topupsaldo`
                           ...
                           {                         
                              "title": "ISI PULSA REGULLER 📱",
                              "description" :"Menampilkan Fitur Operator",
                              "rowId": `${prefix}pulsa`
                          },
                          {
                        "title": "PEMBAYARAN 💵",
                       "description" :"Menampilkan Fitur Pembayaran",
                       "rowId": `${prefix}pay`
                           },
                           {
                        "title": "JASA JOKI KONTAK🗣️",
                       "description" :"Menampilkan Fitur List Menu Jasa Joki KONTAK",
                       "rowId": `${prefix}JasaJoki`
                           },                           
                        ]
                     }],
 listType: 1
...
if (isBanned) return reply(mess.banned)
 ...
 rows: [
                       ...
                       "rowId": `${prefix}topuppubg`
                           ...
                           {                         
                              "title": "HIGGS DOMINO",
                              "description" :"Menampilkan Fitur List Menu Top Up CHIP HIGGS DOMINO",
                              "rowId": `${prefix}higgsdomino`
                           },                                                      
                        ]
                     }],
 listType: 1
...
┊➛ DANA ${dana}
┊➛ OVO ${ovo}
┊➛ SEABANK 901713505838  
┊➛ ALL NAME : MALLZ STORE / IMA ROHIMAH
┏━━━━━━━ ━━━━━━━┓
┊ ║▌║█║▌│║▌║▌█     ┊
┗━━━━━━━ ━━━━━━━┛`
)
...
case 'jadibotwa':
case 'carajadibot':
reply(`*Jika ingin menjadi bot silahkan kunjungi IG : Https://instagram.com/m.a.l.l.zganz`)
break
//SOSMET
//YOUTUBE
//INSTAGRAM
...
case 'ig':
case 'ige':
reply(`*nih Instagram creator, jan lupa follow ya*\Https://instagram.com/m.a.l.l.zganz`)
break
//OWNER/CREATOR
//OWNER
case 'owner':
...
const vcard2 = 'BEGIN:VCARD2\n'  
            ...
            + `FN: MALLZ STORE\n`  
            + `ORG:sibuk;\n` 
            + `TEL;type=CELL;type=VOICE;waid=6288808092768:+6288808092768\n`  
            + 'END:VCARD2'  
...
reply(mess.wait)
query = args.join (" ")
bf = await getBuffer(`https://bagus4p.herokuapp.com/api/glitch?text1=${query}teks2=${query}&apikey=${AlphaBot}`)
Ramdani.sendMessage(from, bf, image, { quoted: froxx, caption: 'Logo maker' })
break
case 'glitch2':
if (isBanned) return reply(mess.banned)
...
Ramdani.sendMessage(from, buffer, video, {mimetype: 'video/mp4', quoted: mek, caption: 'SUBS MALLZ STORE SU'})
break
/*
case 'tiktoknowm':
      if (isBanned) return reply (mess.banned)
...
Ramdani.sendMessage(from, buffer, video, {mimetype: 'video/mp4', quoted: mek, caption: '*Subscribe channel MALLZ STORE dan follow Instagram riyan_ff12*'})
break
case 'igfoto':
if (!isUser) return reply(mess.daftar)
if (isBanned) return reply (mess.banned)
...
break
  ...
  if (!isUser) return reply(mess.daftar)
  if (isBanned) return reply (mess.banned)
  if (args.length == 0) return reply(`Example: ${prefix + command} MALLZ STORE`)
  txt = args.join(" ")
  reply(mess.wait)
...
┌ > ɢᴇɴᴅᴇʀ : 
┌ > sᴛᴀᴛᴜs :
ᴅᴏɴᴛ ғᴏʀɢᴇᴛ ᴛᴏ follow ig : m.a.l.l.zganz
`
   ...
   break
		...
		case 'dellprem':  
                ...
                case 'hidetag':
                  ...
                  Ramdani.sendMessage(from, buffer, image, {quoted: mek, caption: '*SUBS MALLZ STORE BRO*'})
                  break
                   case 'take':
